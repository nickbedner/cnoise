...
static inline __m256 gradient_coherent_noise_3d_avx(__m256 x, float y, float z, int seed, enum NoiseQuality noise_quality) {
  ...
  __m256i x1 = _mm256_insertf128_si256(_mm256_castsi128_si256(x1_low), x1_high, 1);  //_mm256_set_m128i(_mm_add_epi32(x1_high, _mm_set1_epi32(1)), _mm_add_epi32(x1_low, _mm_set1_epi32(1)));
