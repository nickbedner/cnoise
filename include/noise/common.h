...
static inline double make_int_32_range(double n)
{
    if (n >= 1073741824.0)
...
static inline double cubic_interp(double n0, double n1, double n2, double n3, double a)
{
...
static inline double s_curve3(double a)
{
    return (a * a * (3.0 - 2.0 * a));
}

static inline double s_curve5(double a)
{
    double a3 = a * a * a;
    double a4 = a3 * a;
    double a5 = a4 * a;
...
static inline double linear_interp(double n0, double n1, double a)
{
...
static inline double gradient_noise_3d(double fx, double fy, double fz, int ix, int iy, int iz, int seed)
{
    ...
    double xvGradient = random_vectors[vectorIndex][0];
    double yvGradient = random_vectors[vectorIndex][1];
    double zvGradient = random_vectors[vectorIndex][2];
...
static inline double gradient_coherent_noise_3d(double x, double y, double z, int seed, enum NoiseQuality noise_quality)
{
    ...
    case QUALITY_STANDARD:
        xs = s_curve3(x - (double)x0);
        ys = s_curve3(y - (double)y0);
        zs = s_curve3(z - (double)z0);
        break;
    case QUALITY_BEST:
        xs = s_curve5(x - (double)x0);
        ys = s_curve5(y - (double)y0);
        zs = s_curve5(z - (double)z0);
        break;
    }
